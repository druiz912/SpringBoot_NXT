package com.druiz.bosonit.docker.person.infrastructure.controller;
...
public class PersonaController {
    ...
    @GetMapping("getall")
    public List<PersonaOutputDto> getAllUsuarios(@RequestParam(defaultValue = "person", required = false) String outputType) {
        return personaService.getPersonas(outputType);
    }
