package com.druiz.bs9.persona.infrastructure.controller;
...
public class PersonaController {
   ...
   /* @GetMapping("/profesor/feign/{id}")
    public ResponseEntity<ProfesorOutputDto> callServerByFeign(@PathVariable(name = "id") String id) {
        ResponseEntity<ProfesorOutputDto> personaOutputDTOResponseEntity = feignPersona.callServer(id);
